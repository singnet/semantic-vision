...
def print_for_model_digit(model, tag):
    ...
    for digit in range(10):
        ...
        for a in np.arange(-1,1,0.01):
            ...
            Xb_rot = rotatepair_batch.rotate_batch_11(Xb, angles * 180)
            samples = small_batch_run(sess, {input_img: Xb, input_angles:angles}, batch_size, output_img, SMALL_BATCH_SIZE)
