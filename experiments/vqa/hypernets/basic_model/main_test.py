...
def parse_args():
    ...
    parser.add_argument('--modelpath', type=str, default='./saved_models/A3x2_1280_LeakyReLU_Adamax_D0.3_DL0.1_DG0.2_DW0.4_DC0.5_w0_SD9731_initializer_kaiming_normal/model.pth', help='Model path')
