...
LOGDIR = './result_mnist_rot_excl/regular_cnn_00/tb_log_within_train_all/'
SAVEDIR = './result_mnist_rot_excl/regular_cnn_00/model'
...
def model(x, phase_train, keep_prob, reuse = True):
    with tf.variable_scope('Basenet', reuse=reuse):
        ...
        x = tf.layers.dense(x, NCLASSES, activation=lrelu, name='fc_out')
