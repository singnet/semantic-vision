...
tnormdist = torch.distributions.Normal(0.0, 1.0)
...
class BetaVAE_H(nn.Module):
    ...
    def __init__(self, z_dim=10, nc=3):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.ConvTranspose2d(256, 64, 3),      # B,  64,  3,  3
            nn.ReLU(True),
            nn.ConvTranspose2d(64, 64, 4, 2, 1), # B,  64,  6,  6
            nn.ReLU(True),
            nn.ConvTranspose2d(64, 64, 2),  # B,  32,  7,  7
            nn.ReLU(True),
    ...
    def forward(self, x):
        ...
        z = reparametrize(mu, logvar).to(device)
        z = tnormdist.cdf(z.cpu()).cuda()
