...
#plt.title('Ошибка распознавания по реконструкции образов')
...
plt.xlabel('components')
plt.ylabel('digit')
#plt.title('Ошибка распознавания по модулю скрытого представления')
#plt.xlabel('кол-во компонент')
#plt.ylabel('данные')
#plt.show()
...
plt.xlabel('components')
plt.ylabel('digit')
#plt.title('F-мера по ошибке реконструкции образов')
#plt.xlabel('кол-во компонент')
#plt.ylabel('данные')
#plt.show()
...
plt.xlabel('components')
plt.ylabel('digit')
#plt.title('F-мера по модулю скрытого представления')
#plt.xlabel('кол-во компонент')
#plt.ylabel('данные')
#plt.show()
...
plt.xlabel('components')
plt.ylabel('digit')
#plt.title('Интегральный критерий')
#plt.xlabel('кол-во компонент')
#plt.ylabel('данные')
#plt.show()
